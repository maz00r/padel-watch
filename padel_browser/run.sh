...
export AUTO_REGISTER_STAGGER="$(opt auto_register_stagger)"
export TOKEN_CHECK_BEFORE="$(opt token_check_before)"
export AUTO_LOGIN="$(opt auto_login)"
export REMOTE_URL="$(opt remote_url)"
export REMOTE_SECRET="$(opt remote_secret)"
